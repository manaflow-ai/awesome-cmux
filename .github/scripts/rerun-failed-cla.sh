...
[[ "${COMMENT_BODY}" == "recheck" || "${COMMENT_BODY}" == "I have read the CLA Document and I hereby sign the CLA" ]] || fail "Comment is not an accepted CLA trigger"
...
if [[ "${COMMENT_BODY}" == "I have read the CLA Document and I hereby sign the CLA" &&
...
if [[ "${COMMENT_BODY}" == "I have read the CLA Document and I hereby sign the CLA" ]]; then
  validate_triggering_signature_record
fi
