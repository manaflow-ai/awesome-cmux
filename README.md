...
| [SimonMallas/agent-letterbox-cmux](https://github.com/SimonMallas/agent-letterbox-cmux) | Multi | Hand a task over as a durable markdown letter, ring the recipient's pane, get ACK, RESULT, or NACK back. No lead mode, no spawn, no roles — nothing but mail, for any agent you can teach | Shell |
...
| [SimonMallas/agent-letterbox-cmux](https://github.com/SimonMallas/agent-letterbox-cmux) | `orchestrate` `notify` | Hand a task over as a durable markdown letter, ring the recipient's pane, get ACK, RESULT, or NACK back. No lead mode, no spawn, no roles — nothing but mail, for any agent you can teach | Shell |
